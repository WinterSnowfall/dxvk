...
namespace dxvk {
  ...
  D3D9_VK_FORMAT_MAPPING D3D9VkFormatTable::GetFormatMapping(
    ...
    if (Format == D3D9Format::W11V11U10 && !m_adapter->IsD3D8Compatible())
      return D3D9_VK_FORMAT_MAPPING();
  ...
  const DxvkFormatInfo* D3D9VkFormatTable::GetUnsupportedFormatInfo(
    ...
    static const DxvkFormatInfo d32           = { 4, VK_IMAGE_ASPECT_DEPTH_BIT };
    static const DxvkFormatInfo d15s1         = { 2, VK_IMAGE_ASPECT_DEPTH_BIT | VK_IMAGE_ASPECT_STENCIL_BIT };
    static const DxvkFormatInfo d24x4s4       = { 4, VK_IMAGE_ASPECT_DEPTH_BIT | VK_IMAGE_ASPECT_STENCIL_BIT };
    static const DxvkFormatInfo d32f_lockable = { 4, VK_IMAGE_ASPECT_DEPTH_BIT };
    static const DxvkFormatInfo d24fs8        = { 4, VK_IMAGE_ASPECT_DEPTH_BIT | VK_IMAGE_ASPECT_STENCIL_BIT };
