...
namespace dxvk {
  ...
  */
  ...
  private:
    ...
    inline HRESULT IntializeSurface9(DDrawSurface* surface, bool renderTarget);
    ...
    Com<DDrawSurface, false>         m_rt;
    Com<DDrawSurface, false>         m_rt7dev;

    std::array<Com<DDrawSurface, false>, caps::MaxTextureStages> m_textures;
